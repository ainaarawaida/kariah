	...
	protected function _register_controls() {
		...
		if ( ! empty( $account_roles ) ) {
			$this->add_control(
				'account_roles',
				array(
					'label'       => __( 'Show menu for role', 'jet-engine' ),
		...
		$this->add_control(
			'add_main_slug',
			array(
				'label'        => __( 'Add subpage slug to first page', 'jet-engine' ),
				'description'  => __( 'By default subpage slug is not added to the first page of menu. If you enable this options subpage slug will be added to all menu pages includes first one', 'jet-engine' ),
