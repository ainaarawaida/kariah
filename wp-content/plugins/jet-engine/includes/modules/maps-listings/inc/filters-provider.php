 ...
 */
class Filters_Provider extends \Jet_Smart_Filters_Provider_Base {
	...
	public function get_name() {
		return __( 'JetEngine Maps', 'jet-smart-filters' );
	}
	...
	public function add_new_markers_to_response( $response ) {
		...
		$posts       = $instance->get_posts( $settings );
		$map_markers = $instance->get_map_markers( $posts, $settings, false );
	...
	public function get_wrapper_selector() {
		return '.elementor-widget-jet-engine-maps-listing > .elementor-widget-container';
	}
