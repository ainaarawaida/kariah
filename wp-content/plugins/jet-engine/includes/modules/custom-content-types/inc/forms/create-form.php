...
class Create_Form {
	...
	public function prepare_form_field( $field = array(), $index ) {
		...
		<div>
			...
			<div v-if="isEdit">
				<div class="cx-vui-text"><?php
					_e( 'Here you can create new form for JetEngine forms module, configured to fill this CCT from the front-end', 'jet-engine' );
				?></div>
				<cx-vui-button
					...
					tag-name="a"
					target="_blank"
					:url="'<?php echo $action_url ?>&cct_id=' + isEdit"
				>
