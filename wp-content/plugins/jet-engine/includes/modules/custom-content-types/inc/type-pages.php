...
class Type_Pages {
	...
	public function init() {
		...
		if ( $this->is_type_page() && ! empty( $_GET[ $this->action_key ] ) ) {

			require Module::instance()->module_path( 'pages/edit-content-type-item.php' );
			...
			$this->edit_page = new Pages\Edit_Item_Page( array(
				'slug'       => $this->get_page_slug(),
				'action'     => esc_attr( $_GET[ $this->action_key ] ),
	...
	public function get_item_id() {
		return ! empty( $_GET['item_id'] ) ? absint( $_GET['item_id'] ) : false;;
	}
