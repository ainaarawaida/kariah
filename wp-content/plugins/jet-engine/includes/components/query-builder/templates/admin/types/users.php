...
<div class="jet-engine-edit-page__fields">
	...
	<div class="cx-vui-panel">
		...
		>
			<cx-vui-tabs-panel
				name="role"
				label="<?php _e( 'User Role', 'jet-engine' ); ?>"
				key="role"
			>
				<cx-vui-f-select
			...
			<cx-vui-tabs-panel
				...
				label="<?php _e( 'Include/Exclude', 'jet-engine' ); ?>"
				key="include_exclude"
			>
				<cx-vui-input
			...
			>
				...
				<cx-vui-input
					...
					description="<?php _e( 'Offset the returned results', 'jet-engine' ); ?>"
					:wrapper-css="[ 'equalwidth', 'has-macros' ]"
					size="fullwidth"
					name="query_offset"
