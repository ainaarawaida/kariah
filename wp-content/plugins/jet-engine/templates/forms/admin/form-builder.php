<div id="form_builder">
			...
			<div class="jet-form-canvas__field-content">
				...
				<div class="jet-form-canvas__field-end">
					...
					<div class="jet-form-canvas__field-copy" @click="copyField( item, index )">
						<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M13.401 14.5362V4.35745H5.47721V14.5362H13.401ZM13.401 2.92766C13.7848 2.92766 14.1234 3.07518 14.4169 3.37021C14.7104 3.64255 14.8571 3.97163 14.8571 4.35745V14.5362C14.8571 14.922 14.7104 15.2624 14.4169 15.5574C14.1234 15.8525 13.7848 16 13.401 16H5.47721C5.09344 16 4.75482 15.8525 4.46134 15.5574C4.16787 15.2624 4.02113 14.922 4.02113 14.5362V4.35745C4.02113 3.97163 4.16787 3.64255 4.46134 3.37021C4.75482 3.07518 5.09344 2.92766 5.47721 2.92766H13.401ZM11.2338 0V1.46383H2.56504V11.6426H1.14282V1.46383C1.14282 1.07801 1.27827 0.737589 1.54917 0.442553C1.84265 0.147518 2.18127 0 2.56504 0H11.2338Z"/></svg>
					</div>
					<div class="jet-form-canvas__field-conditional-logic" @click="editFieldLogic( item, index )">
						...
						<span class="jet-form-canvas__field-has-conditions" v-if="item.conditionals && item.conditionals.length"></span>
					</div>
				</div>
			</div>
		</grid-item>
					...
					<div class="jet-form-editor__row">
						...
						<div class="jet-form-editor__row-control">
							<select type="text" v-model="currentItem.conditionals[ index ].field">
								...
								<option v-for="field in getAvailableConditionalsFields( currentItem )" :value="field">{{ field }}</option>
							</select>
						</div>
					</div>
					<div class="jet-form-editor__row">
		...
		>
			...
			<template v-if="'repeater_end' !== currentItem.settings.type">
				...
				>
					<div class="jet-form-editor__row-label">
						...
						<div class="jet-form-editor__row-notice">
							...
							<?php printf( '<a href="https://codex.wordpress.org/Formatting_Date_and_Time" target="_blank">%s</a>', __( 'Documentation on date and time formatting', 'jet-engine' ) ); ?>
						</div>
					</div>
					<div class="jet-form-editor__row-control">
				...
				>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<div class="jet-form-editor__row-notice" v-if="inArray(currentItem.settings.generator_function, [ 'get_from_field', 'get_from_option' ] )"><?php
				...
				>
					...
					<div class="jet-form-editor__row-notice">
						...
						<div v-for="field in availableFields" v-if="field !== currentItem.settings.name"><i>%FIELD::{{ field }}%</i></div>
	...
	<div class="jet-form-canvas__preset">
		<div class="jet-form-canvas__preset-enable">
			...
			<div class="jet-form-canvas__preset-controls" v-if="preset.enabled">
				<jet-form-preset-editor v-model="preset" :decode="false" :encode="false" :available-fields="availableFields"></jet-form-preset-editor>
			</div>
		</div>
	</div>
	<div :class="{ 'jet-form-dynamic-settings':true }" v-if="editDynamicSettings && currentItem">
		...
		<div class="jet-form-dynamic-settings__content">
			<jet-form-preset-editor v-if="showLogicEditor" v-model="currentItem.conditionals[ condRuleDynamicIndex ].value" :decode="true" :encode="true" :available-fields="false"></jet-form-preset-editor>
			<jet-form-preset-editor v-else v-model="currentItem.settings.default" :decode="true" :encode="true" :available-fields="false"></jet-form-preset-editor>
			<div class="jet-form-dynamic-settings__actions">
				<button type="button" class="button button-primary button-large" @click="setDynamicSettings"><?php _e( 'Done', 'jet-engine' ); ?></button>
				<button type="button" class="button button-secondary button-large" @click="cancelDynamicSettings"><?php _e( 'Cancel', 'jet-engine' ); ?></button>
			</div>
		</div>
	</div>
</div>
