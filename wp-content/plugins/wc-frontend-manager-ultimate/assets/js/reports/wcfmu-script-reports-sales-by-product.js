jQuery(function( $ ) {
	...
	$( "ul.chart-widgets li.chart-widget h4.section_title:nth-child(1)" ).remove();
	$( "ul.chart-widgets li.chart-widget div.section:nth-child(1)" ).remove();
	
	$( "ul.chart-widgets li.chart-widget h4.section_title:nth-child(1)" ).addClass('open');
});
