...
*/
jQuery(function(){(function(a){a.fn.popModal=function(b){function e(){function c(a){var d=Math.max(v,w,x);return("bottomLeft"==a?0<w:"bottomRight"==a?0<v:0<x)?a:0<w&&w==d?"bottomLeft":0<v&&v==d?"bottomRight":0<x&&x==d?"bottomCenter":a}if(g.inline)var b=d.position().left,h=d.position().top;else b=d.offset().left,h=d.offset().top;var p=parseInt(d.css("marginLeft"));parseInt(d.css("paddingLeft"));var e=parseInt(d.css("marginTop")),k=d.outerHeight(),m=d.outerWidth(),l=f.outerWidth(),q=f.outerHeight(),n,t=
...
function(){var b=a(this).attr("data-popmodal-bind"),b={html:a(b)};void 0!==a(this).attr("data-placement")&&(b.placement=a(this).attr("data-placement"));void 0!==a(this).attr("data-showclose-but")&&(b.showCloseBut=/^truejQuery/i.test(a(this).attr("data-showclose-but")));void 0!==a(this).attr("data-overflowcontent")&&(b.overflowContent=/^falsejQuery/i.test(a(this).attr("data-overflowcontent")));void 0!==a(this).attr("data-ondocumentclick-close")&&(b.onDocumentClickClose=/^truejQuery/i.test(a(this).attr("data-ondocumentclick-close")));
void 0!==a(this).attr("data-ondocumentclick-close-prevent")&&(b.onDocumentClickClosePrevent=a(this).attr("data-ondocumentclick-close-prevent"));void 0!==a(this).attr("data-inline")&&(b.inline=/^truejQuery/i.test(a(this).attr("data-inline")));void 0!==a(this).attr("data-asmenu")&&(b.asMenu=/^falsejQuery/i.test(a(this).attr("data-asmenu")));void 0!==a(this).attr("data-beforeloading-content")&&(b.beforeLoadingContent=a(this).attr("data-beforeloading-content"));a(this).popModal(b)});a.event.special.destroyed={remove:function(a){a.handler&&
