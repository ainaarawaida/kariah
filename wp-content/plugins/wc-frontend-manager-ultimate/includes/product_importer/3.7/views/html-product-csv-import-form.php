...
<form class="wc-progress-form-content woocommerce-importer" enctype="multipart/form-data" method="post">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<input type="checkbox" id="woocommerce-importer-update-existing" name="update_existing" class="wcfm-checkbox" value="1" />
	...
	<div class="wc-actions">
		...
		<button type="submit" class="wcfm_submit_button button-next" value="<?php esc_attr_e( 'Continue', 'woocommerce' ); ?>" name="save_step"><?php esc_html_e( 'Continue', 'woocommerce' ); ?></button>
