...
$wcfm_is_allow_chats_offline = apply_filters( 'wcfm_is_allow_chats_offline', true );
if( !$wcfm_is_allow_chats_offline ) {
...
<div class="collapse wcfm-collapse" id="wcfm_chats_offline_listing">
	
	<div class="wcfm-page-headig">
		<span class="wcfmfa fa-user-clock"></span>
		<span class="wcfm-page-heading-text"><?php _e( 'Offline Chat Messages', 'wc-frontend-manager' ); ?></span>
		<?php do_action( 'wcfm_page_heading' ); ?>
	</div>
	<div class="wcfm-collapse-content">
		<div id="wcfm_page_load"></div>
		<?php do_action( 'before_wcfm_chats_offline' ); ?>
		
		<div class="wcfm-container wcfm-top-element-container">
			<h2><?php _e( 'Offline Chat Messages', 'wc-frontend-manager-ultimate' ); ?></h2>
		...
		<div class="wcfm_chats_offline_filter_wrap wcfm_products_filter_wrap  wcfm_filters_wrap">
			<?php	
			if( $wcfm_is_chats_offline_vendor_filter = apply_filters( 'wcfm_is_chats_offline_vendor_filter', true ) ) {
		...
		<div class="wcfm-container">
			<div id="wcfm_chats_offline_listing_expander" class="wcfm-content">
				<table id="wcfm-chats_offline" class="display" cellspacing="0" width="100%">
					<thead>
						<tr>
						  <th><?php _e( 'User', 'wc-frontend-manager-ultimate' ); ?></th>
						  <th><?php _e( 'Email', 'wc-frontend-manager-ultimate' ); ?></th>
							<th style="max-width: 250px;"><?php _e( 'Message', 'wc-frontend-manager-ultimate' ); ?></th>
		...
		<?php
		do_action( 'after_wcfm_chats_offline' );
		?>
	</div>
</div>