...
$support_order = wc_get_order( $support_order_id );
	...
	<div class="collapse wcfm-collapse">
		<div class="wcfm-collapse-content">
			<div class="wcfm-container wcfm-top-element-container">
				...
				<?php
				echo '<a id="add_new_support_dashboard" class="add_new_wcfm_ele_dashboard text_tip" href="' . $myaccount_page_url . $wcfm_myaccount_support_ticket_endpoint . '/" data-tip="' . __('Support Tickets', 'wc-frontend-manager-ultimate') . '"><span class="wcfmfa fa-life-ring"></span><span class="text">' . __( 'Tickets', 'wc-frontend-manager-ultimate') . '</span></a>';
				?>
			    ...
			    <div class="support_ticket_content_for">
			      ...
			      if( $support_product_id ) {
						...
						if( $support_vendor_id ) {
							if( apply_filters( 'wcfmmp_is_allow_sold_by', true, $support_vendor_id ) && $WCFM->wcfm_vendor_support->wcfm_vendor_has_capability( $support_vendor_id, 'sold_by' ) ) {
						...
						<div class="support_ticket_content_order">
							...
							<?php
							echo '&nbsp;<a class="wcfm_order_for_support img_tip" data-tip="'. __( 'Support Ticket for Order', 'wc-frontend-manager-ultimate' ) . '" target="_blank" href="' . $support_order->get_view_order_url() . '">#' . $support_order_id . '</a>';
							?>
						</div>
						<div class="wcfm_clearfix"></div>
					...
					<div class="wcfm-container">
						<div id="support_ticket_reply_<?php echo $wcfm_support_reply->ID; ?>" class="support_ticket_reply wcfm-content">
							<div class="support_ticket_reply_author">
								...
								<?php
								if( ( apply_filters( 'wcfmmp_is_allow_sold_by', true, $support_vendor_id ) && $WCFM->wcfm_vendor_support->wcfm_vendor_has_capability( $support_vendor_id, 'sold_by' ) && apply_filters( 'wcfm_allow_view_vendor_name', true ) ) || ( $author_id == $support_customer_id ) ) {
									if( wcfm_is_vendor( $author_id ) ) {
					...
					<div class="wcfm-container">
						<div id="wcfm_new_reply_listing_expander" class="wcfm-content">
							...
							$wcfm_support_ticket_reply_fields = apply_filters( 'wcfm_support_ticket_reply_fields', array(
																																																			"support_ticket_reply" => array( 'label' => __( 'Message', 'wc-frontend-manager'), 'type' => 'wpeditor', 'class' => 'wcfm-textarea wcfm_ele wcfm_full_ele wcfm_wpeditor', 'label_class' => 'wcfm_title wcfm_full_ele_title', 'media_buttons' => false, 'teeny' => true ),
