	  ...
	  <div id="wcfm_page_load"></div>
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			if( $wcfm_is_allow_payments = apply_filters( 'wcfm_is_allow_payments', true ) ) {
				echo '<a class="add_new_wcfm_ele_dashboard text_tip" href="'.wcfm_payments_url().'" data-tip="'. __('Transaction History', 'wc-frontend-manager') .'"><span class="wcfmfa fa-credit-card"></span><span class="text">' . __('Transactions', 'dc-woocommerce-multi-vendor' ) . '</span></a>';
			}
			?>
