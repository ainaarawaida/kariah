...
if( ( !current_user_can( 'manage_bookings_settings' ) && !current_user_can( 'manage_bookings' ) ) || !$wcfm_is_allow_manual_booking ) {
	  ...
	  <?php do_action( 'before_wcfm_bookings_manual' ); ?>
		...
		<div class="wcfm-container">
		  <div id="wwcfm_bookings_listing_expander" class="wcfm-content">
		    ...
		    include_once( $WCFMu->plugin_path . 'includes/bookings_manual/class-wcfm-bookings-manual.php' );
