				...
				<table class="totals">
					<tfoot>
						...
						<?php if ( wc_tax_enabled() ) : ?>
							<tr>
								<th class="label description" colspan="2" style="text-align:right;"><?php _e( 'Tax', 'wc-frontend-manager-ultimate' ); ?>:</th>
						...
						<?php if( $order->get_formatted_shipping_address() ) { ?>
							...
							<tr>
								<th class="label description" colspan="2" style="text-align:right;"><?php _e( 'Shipping Tax', 'wc-frontend-manager-ultimate' ); ?>:</th>
								<td class="total price" style="text-align:center;">
									<?php
									if( wcfm_is_marketplace() == 'wcfmmarketplace' ) {
