...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210526_sistemkariah_d1f3b2193af290a57585_20210526123054_archive.zip';
	const ARCHIVE_SIZE		 = '144553159';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd1f3b21-26123054';
    const SECONDARY_PACKAGE_HASH = 'c05abb4-26123054';
	const VERSION			 = '1.4.0';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.4.0==');
		self::log('----------------------------------------------------');
